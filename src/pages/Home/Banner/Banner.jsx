      ...
      <section id="banner">
        <Container>
          <Row>
            ...
            <Col lg={6} md={12} className='text-center mb-5' data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1000">
              <div className="banner-text">
                <h4 className="mt-5 fw-bold pt-5">New Arrivals</h4>
                <h1 className="fw-bold text-dark">Best Kids Toys <br /> Store & Online Shop</h1>
